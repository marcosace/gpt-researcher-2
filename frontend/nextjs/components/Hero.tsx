    ...
    <div className="relative overflow-visible min-h-[80vh] sm:min-h-[85vh] flex items-center pt-[60px] sm:pt-[80px] mt-[-60px] sm:mt-[-130px]">
      ...
      >
        ...
        >
          ...
          >
            <div className="mb-2 xs:mb-3 sm:mb-1 md:mb-0">Diga Adeus a</div>
            <span
              style={{
          ...
          >
            Diga olá ao Buildinho Researcher, seu parceiro de IA para insights rápidos e pesquisas abrangentes.
          </motion.h2>
